...
if (Poco_INCLUDE_DIRS AND Poco_Foundation_LIBRARY)
    ...
    include (${PROJECT_ROOT_PATH}/contrib/libpoco/cmake/FindODBC.cmake)

    list (APPEND Poco_INCLUDE_DIRS
        "${PROJECT_ROOT_PATH}/contrib/libpoco/Foundation/include/"
        "${PROJECT_ROOT_PATH}/contrib/libpoco/Util/include/"
        "${PROJECT_ROOT_PATH}/contrib/libpoco/Net/include/"
        "${PROJECT_ROOT_PATH}/contrib/libpoco/Data/include/"
        "${PROJECT_ROOT_PATH}/contrib/libpoco/XML/include/"
    )

    if (NOT DEFINED POCO_ENABLE_MONGODB OR POCO_ENABLE_MONGODB)
        set (Poco_MongoDB_FOUND 1)
        set (Poco_MongoDB_LIBRARY PocoMongoDB)
        list (APPEND Poco_INCLUDE_DIRS "${PROJECT_ROOT_PATH}/contrib/libpoco/MongoDB/include/")
    endif ()
    ...
    if (ODBC_FOUND)
        ...
        list (APPEND Poco_INCLUDE_DIRS "${PROJECT_ROOT_PATH}/contrib/libpoco/Data/ODBC/include/")
    endif ()
    ...
    if (OPENSSL_FOUND)
        ...
        list (APPEND Poco_INCLUDE_DIRS
            "${PROJECT_ROOT_PATH}/contrib/libpoco/NetSSL_OpenSSL/include/"
            "${PROJECT_ROOT_PATH}/contrib/libpoco/Crypto/include/"
        )
    endif ()

    if (USE_STATIC_LIBRARIES AND USE_INTERNAL_ZLIB_LIBRARY)
        list (APPEND Poco_INCLUDE_DIRS
            "${PROJECT_ROOT_PATH}/contrib/libzlib-ng/"
            "${PROJECT_ROOT_PATH}/contrib/libzlib-ng/"
        )
    endif ()
